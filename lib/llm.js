...
function cleanExcerpt(raw) {
  ...
  let t = raw
    // \u2500\u2500 Navigation menus \u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500
    // "Menu World SECTIONS Iran war..." (NBC/CBS pattern)
    .replace(/\bMenu\b[\s\S]{0,600}?(?=\b[A-Z][a-z]{3,}\b(?:\s[A-Z][a-z]{3,})?)/s, '')
    // BBC nav: "Home News Sport Business Technology ... Watch Live"
    .replace(/\bHome\s+News\b[\s\S]{0,400}?\bWatch\s+Live\b\s*/s, '')
    // "[Publication] News Home [headline]" prefix (ABC News)
    .replace(/^[A-Z][\w\s]{2,30}\bHome\b\s+/m, '')

    // \u2500\u2500 Timestamps \u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500
    // "38 minutes ago" / "2 hours ago" / "1 day ago"
    .replace(/\d+\s+(?:minute|hour|day)s?\s+ago\s*/gi, '')

    // \u2500\u2500 Social / share UI \u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500
    // "Facebook Tweet Twitter Email Threads WhatsApp..."
    .replace(/\b(?:Facebook|Tweet|Twitter|Email|Threads|WhatsApp|Pinterest|Reddit|LinkedIn)\b[\s,]*/g, '')
    // "Share Share article" / "Share Save" / "Save"
    .replace(/\bShare\b(?:\s+\bShare\b)?(?:\s+article)?\s*/gi, '')
    .replace(/\bSave\b[\s,]*/gi, '')
    // "Add as preferred on Google"
    .replace(/\bAdd\s+as\s+preferred\s+on\s+\w+\b[\s,]*/gi, '')
    // "Link Link" / "Link"
    .replace(/\bLink\b(?:\s+\bLink\b)?\s*/g, '')
    // "Copied!"
    .replace(/\bCopied!?\s*/gi, '')
    // "Follow" immediately before a proper noun
    .replace(/\bFollow\s+(?=[A-Z])/g, '')

    // \u2500\u2500 Topic / category tags \u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500
    // "See all topics [Crime Gun violence]"
    .replace(/\bSee\s+all\s+topics?\b[^.]*?(?=[A-Z]|\s*$)/gi, '')
    // "Topic: Unrest, Conflict and War"
    .replace(/\bTopics?\s*:\s*[^.\n]+[.\n]?\s*/gi, '')

    // \u2500\u2500 Author bylines \u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500
    // "By Matthew Doran , Sami Sockol and ABC staff in Gaza"
    .replace(/\bBy\s+[A-Z][a-zA-Z\s,]+?(?:correspondent|reporter|editor|staff|writer)[^\n.]*[.\n]?\s*/gi, '')
    // "Theo Leggett , Transport Correspondent and Jemma Crew , Business reporter"
    // (byline without "By" prefix -- name + role title)
    .replace(/[A-Z][a-zA-Z]+(?:\s+[A-Z]?[a-zA-Z]+){0,3}\s*,\s*(?:Transport|Business|Political|Science|Health|Technology|Arts|Environment|Foreign|Economics|Defence|Legal|Medical|Sports?|Senior|Chief|Special|Digital)\s+(?:Correspondent|Reporter|Editor|Writer|Analyst|Presenter|Producer)[^\n.]*[.\n]?\s*/g, '')
