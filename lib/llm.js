...
//   gemini-2.0-flash — 15 RPM, 2M tokens/day
//
...
const MODEL_FAST  = 'gemini-2.0-flash';   // translate + summarise
const MODEL_SMART = 'gemini-2.0-flash';   // editorial filter (same model, free tier)
