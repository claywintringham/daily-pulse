    ...
    messages: [
      {
        ...
        content: 'Group these news articles by story. Articles about the same real-world event ' +
                 ...
                 '- You MUST synthesise your own headline — do NOT copy any single source title verbatim\n' +
      ...
      messages: [
        {
          ...
          content:
            ...
            '- CLEAN OUTPUT: Do not include URLs, advertisement labels, tracking codes, ' +
            'bylines, timestamps, or any technical artifacts from the source material.\n\n' +
