...
// Returns clusters with a new `summary` string added (40-75 words).
//
// Key requirement: the summary must reflect the angle that ALL or MOST cited
// sources share — not a niche angle from a single source.
//
      ...
      messages: [
        {
          ...
          content:
            ...
            'For each story cluster you will receive a headline and a titles array ' +
            '(one title per cited source). Your task is to produce a summary:\n\n' +
            'SUMMARY — 40–75 words, factual, plain English. ' +
            ...
            '{ "id": "...", "summary": "..." } ' +
            'objects, one per input cluster, same ids. ' +
            'No markdown fences. Each summary must be a single line with no line breaks.',
        },
        {
          role:    'user',
