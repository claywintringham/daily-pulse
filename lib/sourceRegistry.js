...
export const SOURCES = [
...

  {
    ...
    status:           'active',
    needsTranslation: true,
    // on.cc's sitemap.xml is a standard sitemap (no <news:title> tags) — it yields
    // 0 items with fetchSitemapItems. Switch to their RSS feed instead.
    // skipDom:true — no DOM selectors defined; go straight to RSS with no fallback.
    skipDom:          true,
    entryUrl:         'https://hk.on.cc',
    rssUrl:           'https://hk.on.cc/rss/news.xml',
    maxRank:          10,
  },
