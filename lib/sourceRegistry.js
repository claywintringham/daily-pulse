...
export const SOURCES = [
  ...
  // SCMP: soft paywall — some articles are free, some are not. Treated as a
  // QUALIFYING FREE SOURCE (isPaywalled: false) per product decision, meaning
  // SCMP coverage counts toward the 2-source qualification threshold once the
  // adapter is built. The requiresPaywallCheck flag reminds the adapter to
  // verify article accessibility before surfacing a URL.
