...
export const SOURCES = [
  ...
  // The Times (UK): hard paywall — headlines via Google News RSS (own feed is auth-gated).
  // Contributes clustering signal only; no article content ever fetched (isPaywalled).
  {
    id:          'thetimes',
    label:       'The Times',
    bucket:      'international',
    ...
    rssUrl:      'https://news.google.com/rss/search?q=site:thetimes.com&hl=en-GB&gl=GB&ceid=GB:en',
    renderMode:  'fetch',
    containers: ['main'],
