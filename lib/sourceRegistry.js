...
export const SOURCES = [
  ...
  // No RSS feed available — DOM-only via Next.js SSR page.
  // Headlines sit in <h3> inside <a.mpmSwiperLink>; URLs are relative to entryUrl.
  {
    id:      'tvbpearl',
    label:   'TVB Pearl',
    bucket:  'local',
    ...
    excludeSelectors: ['nav', 'footer', '.advertisement', '.ad'],
    maxRank: 10,
  },
