...
export const SOURCES = [
  ...
  // Direct scraping is not possible (client-side rendered, private API).
  // The adapter fetches a Google News site:-scoped RSS query instead, which
  // indexes TVB Pearl articles in near-real-time.
  {
    id:      'tvbpearl',
    label:   'TVB Pearl',
    bucket:  'local',
  ...
  // Phase 3 — HK local stubs (require translation — deferred)
  { id: 'tvb',     label: 'TVB News', bucket: 'local', isPaywalled: false, phase: 3, status: 'stub', entryUrl: 'https://news.tvb.com/tc',   requiresTranslation: true },
