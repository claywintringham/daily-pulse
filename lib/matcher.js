...
/**
 * Strip basic HTML tags + decode common entities from an RSS description.
 * RSS descriptions routinely contain embedded <p>, <a>, <img>, etc.
 */
  ...
  return items.map(item => {
    ...
    if (exactUrl) {
      return {
        ...
        description:     exactUrl.description || null,
